...
for subdir in fe_03_p2_sph1  fe_03_p2_sph3  fe_03_p2_sph5  fe_03_p2_sph7 \
  fe_03_p1_tran  fe_03_p2_sph2  fe_03_p2_sph4 \
...
if [ $stage -le 0 ]; then
  ...
  find $links/fe_03_p2_tran/data -iname '*.txt'  > $tmpdir/transcripts.flist
